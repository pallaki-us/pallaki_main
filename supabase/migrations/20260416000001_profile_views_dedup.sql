-- Create profile_views table if not already applied from 20260411000003.
...
CREATE UNIQUE INDEX IF NOT EXISTS profile_views_dedup_idx
  ON public.profile_views (vendor_id, viewer_id, (viewed_at::date))
  WHERE viewer_id IS NOT NULL;

ALTER TABLE public.profile_views ENABLE ROW LEVEL SECURITY;

-- Drop old policies before recreating (safe if they don't exist)
...
SECURITY DEFINER
AS $$
  INSERT INTO public.profile_views (vendor_id, viewer_id, viewed_at)
  VALUES (p_vendor_id, p_viewer_id, now())
  ON CONFLICT (vendor_id, viewer_id, (viewed_at::date)) DO NOTHING;
$$;
