                ...
                <div className="details-form" style={{ marginTop: '1.5rem' }}>
                  ...
                  <div className="df"><label>Category</label>
                    <select value={category} onChange={e => setCategory(e.target.value)}>
                      {['Photography','Videography','Mehndi Artists','Bridal Makeup','Catering','Decor','Music & DJ','Event Planners','Party Rentals','Wedding Venue','Wedding Attire & Boutique'].map(c => <option key={c}>{c}</option>)}
                    </select>
                  </div>
